...
class StatsApi:
    ...
    def stats_retrieve(
        ...
        _param = self._stats_retrieve_serialize(
    ...
    @validate_call
    def stats_retrieve_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def stats_retrieve_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
