...
class ProofFull(BaseModel):
    ...
    updated: datetime
    __properties: ClassVar[List[str]] = ["id", "location_id", "location", "file_path", "mimetype", "type", "image_thumb_path", "location_osm_id", "location_osm_type", "date", "currency", "price_count", "owner", "created", "updated"]
