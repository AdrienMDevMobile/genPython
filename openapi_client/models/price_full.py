...
class PriceFull(BaseModel):
    ...
    updated: datetime
    __properties: ClassVar[List[str]] = ["id", "product_id", "location_id", "proof_id", "product", "location", "proof", "product_code", "product_name", "category_tag", "labels_tags", "origins_tags", "price", "price_is_discounted", "price_without_discount", "price_per", "currency", "location_osm_id", "location_osm_type", "date", "owner", "created", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "product": ProductFull.from_dict(obj["product"]) if obj.get("product") is not None else None,
            "location": Location.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "proof": Proof.from_dict(obj["proof"]) if obj.get("proof") is not None else None,
