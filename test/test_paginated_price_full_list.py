...
class TestPaginatedPriceFullList(unittest.TestCase):
    """PaginatedPriceFullList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedPriceFullList:
        """Test PaginatedPriceFullList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedPriceFullList`
        """
        model = PaginatedPriceFullList()
        if include_optional:
            return PaginatedPriceFullList(
                ...
                results = [
                    openapi_client.models.price_full.PriceFull(
                        id = 56, 
                        product_id = 56, 
                        location_id = 56, 
                        proof_id = 56, 
    ...
    def testPaginatedPriceFullList(self):
        """Test PaginatedPriceFullList"""
